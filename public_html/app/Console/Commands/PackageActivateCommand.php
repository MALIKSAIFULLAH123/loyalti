...
class PackageActivateCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'package:activate {package}
    {--rebuild}';
     ...
     * @var string
     */
    protected $description = 'Activate installed package';
    ...
    public function handle()
    {
        ...
        if ($package->is_active) {
            $this->comment(sprintf('Package %s has already been activated.', $id));
            return;
        }
        ...
        $this->info(sprintf('Package %s has been successfully activated.', $id));
