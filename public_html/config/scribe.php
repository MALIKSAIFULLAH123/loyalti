...
return [
    ...
    'description' => implode(PHP_EOL, [
        sprintf('Version: v%s', env('MFOX_APP_VERSION')),
        sprintf('Updated: %s', date("M d, Y")),
    ]) ,

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => env('TRY_IT_OUT_API_URL', 'http://localhost'),
...
//                    'Accept'       => 'application/json',
    ...
    'static' => [
         ...
         */
        'output_path' => 'build/docs/rest-api',
    ],
    ...
    'auth' => [
         ...
         * Set this to null if you want Scribe to use a random value as a placeholder instead.
         */
         ...
         */
        'extra_info' => 'You can retrieve your token with api <a href="#user-POSTuser-login">Generate API token</a>.',
    ],
...
INTRO
    ...
    'strategies' => [
        'metadata' => [
            MetaFox\Platform\ApiDoc\GetFromDocBlocks::class
        ],
        'urlParameters' => [
            MetaFox\Platform\ApiDoc\UrlParameters\GetFromLaravelAPI::class,
            Strategies\UrlParameters\GetFromLumenAPI::class,
            Strategies\UrlParameters\GetFromUrlParamTag::class,
        ],
        'queryParameters' => [
            MetaFox\Platform\ApiDoc\QueryParameters\GetFromFormRequest::class,
        ...
        'bodyParameters' => [
            MetaFox\Platform\ApiDoc\BodyParameters\GetFromFormRequest::class,
     ...
     *
     */
    'routeMatcher' => \MetaFox\Platform\ApiDoc\RouteMatcher::class,
