...
class MigratePageAvatar extends AbstractJob
{
    use Dispatchable;
    ...
    public function handle(): void
    {
        ...
        $pages = Page::query()
            ...
            ->whereNotNull('pages.avatar_file_id')
            ->whereNull('pages.avatar_id')
            ->orderBy('id')
            ->get();
        ...
        foreach ($collections as $collection) {
            MigrateChunkingPageAvatar::dispatch($collection->pluck('id')->toArray());
        }
    }
}
