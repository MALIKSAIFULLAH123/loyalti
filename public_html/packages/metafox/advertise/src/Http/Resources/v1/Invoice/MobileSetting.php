...
class MobileSetting extends ResourceSetting
{
    protected function initialize(): void
    {
        ...
        $this->add('paymentItem')
            ->apiUrl('core/mobile/form/advertise_invoice.payment/:id');

        $this->add('searchForm')
            ->apiUrl('core/mobile/form/advertise_invoice.search_form');
        ...
        $this->add('searchItem')
            ...
            ->apiParams([
                ...
                'end_date'   => ':end_date',
                'status'     => ':status',
            ])->placeholder(__p('advertise::phrase.search_invoice'));
    }
}
