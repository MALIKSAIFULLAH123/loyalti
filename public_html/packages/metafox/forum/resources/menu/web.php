...
return [
    ...
    [
        'showWhen' => [
            ...
            ['truthy', 'acl.forum.forum_thread.create_as_wiki'],
        ],
        'menu'       => 'core.quickCreateMenu',
        'name'       => 'forum_wiki',
    ...
    [
        ...
        'menu'       => 'forum.sidebarMenu',
        'name'       => 'add_wiki',
        'label'      => 'forum::phrase.forum_phrase_menu_create_new_wiki',
        'ordering'   => 10,
        'as'         => 'sidebarButton',
        'icon'       => 'ico-plus',
        'to'         => '/forum/thread/add',
    ...
    [
        'showWhen' => [
            ...
            [
                'or',
                ['truthy', 'acl.forum.forum_thread.create'],
                ['truthy', 'item.extra.can_create_thread_as_mod'],
            ],
        ],
        'menu'  => 'forum.forum.headerActionOnDetailForumMenu',
        'name'  => 'forum',
        'label' => 'forum::phrase.forum_phrase_menu_create_new_thread',
        'icon'  => 'ico-plus',
        'to'    => '/forum/thread/add?forum_id=:id',
    ],
];
