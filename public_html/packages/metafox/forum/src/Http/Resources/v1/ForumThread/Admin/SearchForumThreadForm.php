...
class SearchForumThreadForm extends AbstractForm
{
    ...
    {
        $this->action('forum/forum-thread/browse')
            ->acceptPageParams(['q', 'user_name', 'owner_name', 'view', 'forum_id', 'created_from', 'created_to'])
            ->submitAction(MetaFoxForm::FORM_SUBMIT_ACTION_SEARCH)
            ->setValue([
                'view'         => ThreadViewAdminScope::VIEW_DEFAULT,
                'created_from' => null,
                'created_to'   => null,
            ]);
    }
    ...
    protected function initialize(): void
    {
        ...
        $basic->addFields(
            ...
            Builder::choice('view')
                ...
                ->options(ThreadViewAdminScope::getViewOptions()),
