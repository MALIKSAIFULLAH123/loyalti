...
class DataGrid extends Grid
{
    ...
    protected function initialize(): void
    {
        ...
        $this->addColumn('reg_name')
            ->header(__p('group::phrase.group_privacy'))
            ->alignCenter()
            ->width(200);
        ...
        $this->addColumn('statistic.total_member')
            ->header(__p('group::phrase.total_member'))
            ->sortable()
            ->asNumber()
            ->alignCenter()
        ...
        $this->withExtraData([
            'show_total'        => true,
            'total_item_phrase' => 'total_value_groups',
        ]);
