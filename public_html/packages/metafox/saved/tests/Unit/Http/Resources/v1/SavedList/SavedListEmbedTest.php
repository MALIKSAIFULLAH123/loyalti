...
use MetaFox\Saved\Http\Resources\v1\SavedList\SavedListEmbed as Resource;
use MetaFox\Saved\Http\Resources\v1\SavedList\SavedListEmbedCollection as ResourceCollection;
use MetaFox\Saved\Models\SavedList as Model;
use Tests\TestCase;

class SavedListEmbedTest extends TestCase
{
    /**
     * @return Model $model
     */
