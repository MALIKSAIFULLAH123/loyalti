...
namespace MetaFox\Featured\Http\Requests\v1\Transaction\Admin;
 ...
 *
 * @link \MetaFox\Featured\Http\Controllers\Api\v1\TransactionAdminController::index
...
class IndexRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'status' => ['sometimes', 'nullable', new AllowInRule(array_column(Feature::getTransactionStatusSearchOptions(), 'value'))],
