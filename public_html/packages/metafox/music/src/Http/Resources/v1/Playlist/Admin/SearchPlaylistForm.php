...
/**
 * Class SearchPlaylistForm
 * @property ?Model $resource
 * @ignore
 * @codeCoverageIgnore
 */
class SearchPlaylistForm extends AbstractForm
{
    protected function prepare(): void
    {
        $this->action('music/music-playlist/browse')
            ->acceptPageParams(['q', 'user_name', 'created_from', 'created_to'])
