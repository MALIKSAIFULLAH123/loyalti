...
return [
    ...
    'added_total_photo_and_total_video_to_the_album'         => 'added {total_photo, plural, =0{} =1{# photo} other{# photos}}{total_photo, plural, =0{} other{{total_video, plural, =0{} other{ and }}}}{total_video, plural, =0{} =1{# video} other{# videos}} to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>',
    ...
    'add_photos_label'                                       => '{allowVideo, select, 1 {Photos/Videos} other {Photos}}',
    ...
    'allow_photo_category_selection_description'             => 'Enable this feature to give users the option to select categories directly while uploading/editing photos.',
    ...
    'shared_a_photo_from_album_name_on_owner_name'           => 'added a photo to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>{owner_type , select,
    ...
    'created_a_photo_album_on_owner'                         => '{total_item, select,
        ...
        other{{total_photo, select,
            0{{total_video, select,
                0{created the empty album: <a class="simpleLink" href="{album_link}">{album_name}</a>}
                1{added a video to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>}
                other{added {total_video} videos to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>}
            }}
            1{added a photo {total_video, select,
                0{}
                1{and a video}
                other{and {total_video} videos}} to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>}
            other{{total_video, select,
                0{added {total_photo} photos to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>}
                1{added {total_photo} photos and a video to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>}
                other{added {total_photo} photos and {total_video} videos to photo album <a class="simpleLink" href="{album_link}">{album_name}</a>}
            }}
        }}
    }{owner_type , select,
        group{ in <a class="simpleLink" href="{owner_link}">{owner_name}</a>}
    ...
    'enter_album_description'                                => 'Enter Description',
    'enter_album_name'                                       => 'Enter Name',
    'entity_type_photo'                                      => 'photo',
    'entity_type_photo_album'                                => 'photo album',
    'entity_type_photo_category'                             => 'category',
    'entity_type_photo_set'                                  => 'photo set',
    'feature'                                                => 'Feature',
    ...
    'photo_album_s_deleted_successfully'                     => 'Photo album(s) was deleted successfully.',
    ...
    'parent_cover_picture_update_successfully'               => ':owner_type_name\'s cover was updated successfully.',
    'parent_avatar_picture_update_successfully'              => ':owner_type_name\'s avatar was updated successfully.',
    ...
    'photo_approve_notification_type'                        => 'Photo Approved Notification',
    ...
    'photo_s_deleted_successfully'                           => 'Photo(s) was deleted successfully.',
    ...
    'photo_s_has_been_approved'                              => 'Photo(s) has been approved.',
    ...
    'photos_uploaded_successfully'                           => 'Photo(s) was uploaded successfully.',
    ...
    'quota_control_photo_album_invalid'                      => 'You have reached your limit. You are currently unable to post new photo album.',
    ...
    'tab_photo_all_albums'                                   => 'All Albums',
    'tab_photo_all_photos'                                   => 'All Photos',
    'tab_photo_my_albums'                                    => 'My Albums',
    'tab_photo_my_photos'                                    => 'My Photos',
    ...
    'upload_multiple_photo_description'                      => 'You can choose {allowVideo, select, 0{photo} other{photo or video}} file(s) to upload. The file size is {maxPhotoSize, select, 0{unlimited for photo file} other{limited to {valuePhotoSize} for photo file}}{allowVideo, select, 0{} other { and {maxVideoSize, select, 0{video file} other{{valueVideoSize} for video file}}}}. If the upload does not work, please try smaller file. {maxMediaPerUpload, select, 0{} other {Maximum number of files you can upload each time is {maxMediaPerUpload}.}}',
    ...
    'purchase_sponsor_price_label'                           => 'How much is the sponsor space worth for items? This works in a CPM basis.',
    'purchase_sponsor_price_desc'                            => '',
    'purchase_sponsor_price_photo_label'                     => 'How much is the sponsor space worth for photos? This works in a CPM basis.',
    'purchase_sponsor_price_photo_desc'                      => '',
    'purchase_sponsor_price_photo_album_label'               => 'How much is the sponsor space worth for albums? This works in a CPM basis.',
    'purchase_sponsor_price_photo_album_desc'                => '',
    'sponsor_setting_photo'                                  => 'Photo',
    'sponsor_setting_photo_album'                            => 'Photo Album',
    'quota_control_photo'                                    => 'Photo',
    'quota_control_photo_album'                              => 'Photo Album',
    'feature_setting_photo'                                  => 'Photo',
    'feature_setting_photo_album'                            => 'Photo Album',
    'un_sponsor_in_feed'                                     => 'Unsponsor in Feed',
    'sponsor_title_photo'                                    => 'Photo: :title',
    'sponsor_title_photo_album'                              => 'Photo Album: :title',
    'add_some_content_to_your_photo_album'                   => 'Add some content to your photo album.',
    'add_some_content_to_your_photo'                         => 'Add some content to your photo.',
    'photo_follower_notification_type'                       => 'Someone you follow has created new photos.',
    'category_another'                                       => 'Another',
    'category_artisan_crafts'                                => 'Artisan Crafts',
    'category_cartoons_comics'                               => 'Cartoons & Comics',
    'category_comedy'                                        => 'Comedy',
    'category_community_projects'                            => 'Community Projects',
    'category_contests'                                      => 'Contests',
    'category_customization'                                 => 'Customization',
    'category_designs_interfaces'                            => 'Designs & Interfaces',
    'category_digital_art'                                   => 'Digital Art',
    'category_fan_art'                                       => 'Fan Art',
    'category_film_animation'                                => 'Film & Animation',
    'category_fractal_art'                                   => 'Fractal Art',
    'category_game_development_art'                          => 'Game Development Art',
    'category_literature'                                    => 'Literature',
    'category_people'                                        => 'People',
    'category_pets_animals'                                  => 'Pets & Animals',
    'category_photography'                                   => 'Photography',
    'category_resources_stock_images'                        => 'Resources & Stock Images',
    'category_science_technology'                            => 'Science & Technology',
    'category_sports'                                        => 'Sports',
    'category_traditional_art'                               => 'Traditional Art',
];
