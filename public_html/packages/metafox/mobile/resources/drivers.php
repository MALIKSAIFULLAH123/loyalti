...
return [
    ...
    [
        'driver'     => 'MetaFox\\Mobile\\Http\\Resources\\v1\\Admin\\SmartBannerSettingForm',
        'type'       => 'form-settings',
        'name'       => 'mobile.smart_banner',
        'version'    => 'v1',
        'resolution' => 'admin',
        'title'      => 'mobile::phrase.smart_banner_configs',
    ],
    [
        ...
        'is_preload'  => false,
        'title'       => 'core::phrase.settings',
        'url'         => '/mobile-integration/setting',
