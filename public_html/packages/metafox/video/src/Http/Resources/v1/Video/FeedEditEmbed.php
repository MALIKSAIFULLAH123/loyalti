 ...
 */
class FeedEditEmbed extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $thumbnail = VideoFacade::getDataWithContext($context, $this->resource);
        ...
        return [
            ...
            'extra'             => $this->getExtra(),
            'thumbnail'         => $this->resource->thumbnail_file_id ? [
                'id'    => $this->resource->thumbnail_file_id,
                'image' => $thumbnail,
            ] : null,
        ];
    }
