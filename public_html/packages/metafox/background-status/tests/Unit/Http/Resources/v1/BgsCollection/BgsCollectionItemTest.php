...
use MetaFox\BackgroundStatus\Http\Resources\v1\BgsCollection\BgsCollectionItem as Resource;
use MetaFox\BackgroundStatus\Http\Resources\v1\BgsCollection\BgsCollectionItemCollection as ResourceCollection;
use MetaFox\BackgroundStatus\Models\BgsCollection as Model;
use Tests\TestCase;

class BgsCollectionItemTest extends TestCase
{
    /**
     * @return Model $model
     */
