...
use MetaFox\Poll\Http\Resources\v1\Poll\MobileSetting as Setting;
use Tests\TestCase;

/**
 * --------------------------------------------------------------------------
 *  Poll Mobile Resource Config Test
 * --------------------------------------------------------------------------
 *  stub: /packages/resources/resource_setting_test.stub.
 */

/**
 * Class PollMobileSettingTest.
 */
class PollMobileSettingTest extends TestCase
{
