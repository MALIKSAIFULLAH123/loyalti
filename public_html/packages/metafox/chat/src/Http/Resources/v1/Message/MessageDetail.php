...
class MessageDetail extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $relatedMessages = resolve(MessageRepositoryInterface::class)->getRelatedMessages($this->resource, $attributes);
        ...
        return [
            ...
            'related_messages' => [
                'top_messages'    => new RelatedMessageItemCollection($relatedMessages['top_messages']),
                'bottom_messages' => new RelatedMessageItemCollection($relatedMessages['bottom_messages']),
            ],
