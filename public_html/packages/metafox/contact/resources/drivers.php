...
return [
    ...
    [
        'driver'     => 'MetaFox\\Contact\\Http\\Resources\\v1\\Category\\Admin\\DataGrid',
        'type'       => 'data-grid',
        'name'       => 'contact.category.category',
        'version'    => 'v1',
        'resolution' => 'admin',
    ],
    [
    ...
    [
        'driver'     => 'MetaFox\\Contact\\Http\\Resources\\v1\\Category\\Admin\\DestroyCategoryForm',
        'type'       => 'form',
        'name'       => 'contact.contact_category.destroy',
        'version'    => 'v1',
        'resolution' => 'admin',
        'is_active'  => true,
        'is_preload' => false,
    ...
    [
        'driver'     => 'MetaFox\\Contact\\Models\\Category',
        'type'       => 'entity',
        'name'       => 'contact_category',
        'is_active'  => true,
        'is_preload' => false,
