...
use Foxexpert\Sevent\Models\Ticket as Resource;
...
class TicketPolicy
{
    ...
    {
        if ($user->hasPermissionTo('sevent_ticket.moderate')) {
            return true;
        }

        if (!$user->hasPermissionTo('sevent_ticket.view')) {
            return false;
        }
    ...
    public function view(?User $user, Entity $resource): bool
    {
        ...
        if (!$resource->isApproved()) {
            ...
            if ($user->hasPermissionTo('sevent_ticket.approve')) {
                return true;
            }
    ...
    {
        if (!$user->hasPermissionTo('sevent_ticket.create')) {
            return false;
        }
        ...
        if ($owner instanceof User) {
            if ($owner->entityId() != $user->entityId()) {
                ...
                if (!UserPrivacy::hasAccess($user, $owner, 'rewar.share_rewars')) {
                    return false;
                }
            }
        }
    ...
    {
        if (!$user->hasPermissionTo('sevent_ticket.update')) {
            return false;
        }
    ...
    public function delete(?User $user, ?Entity $resource = null): bool
    {
        ...
        if (!$resource->isApproved() && $user->hasPermissionTo('sevent_ticket.approve')) {
            return true;
        }
    ...
    public function deleteOwn(?User $user, ?Entity $resource = null): bool
    {
        ...
        if (!$user->hasPermissionTo('sevent_ticket.delete')) {
            return false;
        }
    ...
    public function publish(User $user, ?Entity $ticket): bool
    {
        if (!$ticket instanceof Resource) {
            return false;
        }
    ...
    {
        if (!$owner instanceof HasPrivacyMember) {
            return $context->hasPermissionTo('sevent_ticket.auto_approved');
        }
