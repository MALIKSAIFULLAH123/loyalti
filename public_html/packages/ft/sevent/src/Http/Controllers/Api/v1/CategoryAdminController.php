...
use Foxexpert\Sevent\Http\Requests\v1\Category\Admin\DeleteRequest;
use Foxexpert\Sevent\Http\Requests\v1\Category\Admin\IndexRequest;
use Foxexpert\Sevent\Http\Requests\v1\Category\Admin\StoreRequest;
use Foxexpert\Sevent\Http\Requests\v1\Category\Admin\UpdateRequest;
use Foxexpert\Sevent\Http\Resources\v1\Category\Admin\CategoryItem as Detail;
use Foxexpert\Sevent\Http\Resources\v1\Category\Admin\CategoryItemCollection as ItemCollection;
use Foxexpert\Sevent\Http\Resources\v1\Category\Admin\DestroyCategoryForm;
use Foxexpert\Sevent\Http\Resources\v1\Category\Admin\StoreCategoryForm;
...
use Foxexpert\Sevent\Listeners\PackageSettingListener;
...
class CategoryAdminController extends ApiController
{
    ...
    public function update(UpdateRequest $request, int $id): JsonResponse
    {
        ...
        return $this->success(new Detail($data), [], __p('core::phrase.categories_successfully_updated'));
    }
