...
class PasswordVerificationForm extends AbstractForm
{
    /**
     * @var string|null
     */
    ...
    protected function addGatewayDetail(?Section $section = null): void
    {
        ...
        $section->label(__p('payment::phrase.payment_with_gateway_title', ['title' => Arr::get($gatewayInfo, 'title')]))
            ->addFields(
                ...
                Builder::divider('gateway_divider')
                    ->sx([
                        'mt' => 2,
                    ]),
            )
    ...
    protected function initialize(): void
    {
        ...
        $this->addFooterFields();
    }

    protected function addFooterFields(): void
    {
     ...
     * @return string
     */
    public function getProcessChildId(): string
    {
    ...
    {
        return $this->setMultiStepFormMeta($this->getActionMeta()->toArray());
    }
}
