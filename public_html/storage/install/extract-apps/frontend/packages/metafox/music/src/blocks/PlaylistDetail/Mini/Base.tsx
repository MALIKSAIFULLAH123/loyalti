...
import Waveform from '@metafox/music/blocks/Waveform/Waveform';
import PlayList from '@metafox/music/blocks/PlaylistDetail/PlayList';
...
const PlaylistContent = styled('div', { name: 'PlaylistContent' })(({ theme }) => ({
  fontSize: 15,
  lineHeight: 1.33,
