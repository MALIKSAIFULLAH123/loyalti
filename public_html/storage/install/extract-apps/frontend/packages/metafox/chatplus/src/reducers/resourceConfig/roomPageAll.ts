  ...
  menus: {
    itemActionMenu: {
      items: [
        ...
        {
          label: 'conversation_info',
          icon: 'ico-info-circle-alt-o',
          value: 'chatplus/room/sideInfo',
          testid: 'markAsRead',
          showWhen: ['truthy', 'isMobile']
        },
        {
          label: 'change_group_name',
          icon: 'ico-pencilline-o',
          value: 'chatplus/room/changeNameGroup',
          testid: 'changeNameGroup',
          showWhen: [
            'and',
        ...
        },
        {
          ...
          value: 'chatplus/room/createGroup',
...

        {
          ...
          value: 'chatplus/room/addNewMembersPage',
        ...
        },
        {
          ...
          value: 'chatplus/room/showPresentMembers',
        ...
        },
        {
          label: 'edit_info',
          icon: 'ico-info-circle-alt-o',
          value: 'chatplus/room/editInfoSettings',
