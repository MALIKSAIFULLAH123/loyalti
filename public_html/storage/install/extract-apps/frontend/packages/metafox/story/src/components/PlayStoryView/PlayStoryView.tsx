...
import PlayHeaderStory from './PlayHeaderStory';
...
function PlayStoryView({ story, isModal = true, isOwner = false }: Props) {
  const {
    assetUrl,
    useIsMobile,
    jsxBackend,
  ...
  const { reactions, readyStateFile, buffer } = storyContent || {};
          ...
          <StoryImage ref={containerImgRef} width={width}>
            ...
            <ImageWrapper height={height} width={width}>
              ...
              <ContentStoryBlock
                ...
                height={height}
                width={width}
                onLoadCallBack={updateViewStory}
              />
            </ImageWrapper>
