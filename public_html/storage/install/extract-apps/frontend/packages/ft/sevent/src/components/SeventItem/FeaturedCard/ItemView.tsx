/**
 * @type: itemView
 * name: sevent.itemView.featuredCard
 */
...
export function SeventItemView({
  ...
  return (
    <ItemView wrapAs={wrapAs} wrapProps={wrapProps} testid="sevent">
      ...
      />
      <ItemText>
        <CategoryStyled isMobile={isMobile} data={categories} sx={{ mb: { sm: 1, xs: 0 } }} />
