...
return [
    ...
    [
        'variant'     => 'outlined',
        'enabledWhen' => ['falsy', 'item.is_liked'],
    ...
    [
        ...
        'to'       => '/group/manage/:id/membership_requests',
    ],
    [
        'tab'      => 'membership_invites',
        'showWhen' => [
            'and',
        ...
        'ordering' => 4,
        'icon'     => 'ico-envelope-o',
        'to'       => '/group/manage/:id/membership_invites',
    ],
    [
        'tab'      => 'group_rules',
        'showWhen' => [
    ...
    [
        ...
        'label'    => 'group::phrase.approve',
        'ordering' => 2,
        'value'    => 'group/acceptMemberRequest',
        'icon'     => 'ico-check',
    ],
    [
        'showWhen' => [
