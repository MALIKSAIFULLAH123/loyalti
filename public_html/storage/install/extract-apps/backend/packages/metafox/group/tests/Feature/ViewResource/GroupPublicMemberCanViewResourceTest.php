...
class GroupPublicMemberCanViewResourceTest extends TestCase
{
    /**
    ...
    public function testCanViewDefaultSuccess($params)
    {
        ...
        $this->assertTrue($owner->can('share', [Blog::class, $blog]));
        $this->assertTrue($owner->can('share', [Photo::class, $photo]));
        ...
        $this->assertTrue($groupAdmin->can('share', [Blog::class, $blog]));
        $this->assertTrue($groupAdmin->can('share', [Photo::class, $photo]));
        ...
        $this->assertTrue($groupMember->can('share', [Blog::class, $blog]));
        $this->assertTrue($groupMember->can('share', [Photo::class, $photo]));

        // Stranger can view group and can view post.
        $this->assertTrue($stranger->can('viewAny', [Blog::class, $group]));
        $this->assertTrue($stranger->can('viewAny', [Photo::class, $group]));
        $this->assertTrue($stranger->can('view', [Blog::class, $blog]));
        $this->assertTrue($stranger->can('view', [Photo::class, $photo]));
        $this->assertTrue($stranger->can('comment', [Blog::class, $blog]));
        $this->assertTrue($stranger->can('comment', [Photo::class, $photo]));
        $this->assertTrue($stranger->can('like', [Blog::class, $blog]));
        $this->assertTrue($stranger->can('like', [Photo::class, $photo]));
        $this->assertTrue($stranger->can('share', [Blog::class, $blog]));
        $this->assertTrue($stranger->can('share', [Photo::class, $photo]));
