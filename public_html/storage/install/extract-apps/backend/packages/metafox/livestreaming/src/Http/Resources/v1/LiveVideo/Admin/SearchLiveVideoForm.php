...
class SearchLiveVideoForm extends AbstractForm
{
    ...
    {
        $this->action('livestreaming/live-video/browse')
            ->acceptPageParams(['q', 'user_name', 'owner_name', 'view', 'duration', 'created_from', 'created_to'])
    ...
    protected function initialize(): void
    {
        ...
        $basic->addFields(
            ...
            Builder::choice('duration')
                ...
                ->options([
                    [
                        'label' => __p('livestreaming::phrase.longer_than_minutes', ['value' => DurationScope::getSetting()]),
                        'value' => DurationScope::DURATION_LONGER,
                    ],
                    [
                        'label' => __p('livestreaming::phrase.shorter_than_minutes', ['value' => DurationScope::getSetting()]),
                        'value' => DurationScope::DURATION_SHORTER,
                    ],
                ]),
