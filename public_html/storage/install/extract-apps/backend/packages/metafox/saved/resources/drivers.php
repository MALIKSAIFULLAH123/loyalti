...
return [
    ...
    [
        'driver'     => 'MetaFox\\Saved\\Http\\Resources\\v1\\Saved\\SearchSavedSimpleForm',
        'type'       => 'form',
        'name'       => 'saved.search_simple',
        'version'    => 'v1',
        'resolution' => 'web',
        'is_active'  => true,
        'is_preload' => true,
    ...
    [
        'driver'     => 'MetaFox\\Saved\\Notifications\\AddFriendToListNotification',
        'type'       => 'notification',
        'name'       => 'saved_add_friend_to_list',
        'is_active'  => true,
        'is_preload' => false,
    ],
];
