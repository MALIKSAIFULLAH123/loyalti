...
class MigratePaymentGatewayId
{
    ...
    private function migrateMysql(): void
    {
        DB::statement("
            ...
            JOIN subscription_invoices ON payment_orders.item_id = subscription_invoices.id
            SET payment_orders.gateway_id = subscription_invoices.payment_gateway
            WHERE
              payment_orders.item_type = 'subscription_invoice'
    ...
    private function migratePostgres(): void
    {
        DB::statement("
            UPDATE
              payment_orders
            SET
              gateway_id = subscription_invoices.payment_gateway
            FROM
            ...
            WHERE
              ...
              AND payment_orders.gateway_id = 0
              AND payment_orders.status <> 'init'
              AND payment_orders.item_id = subscription_invoices.id
        ");
