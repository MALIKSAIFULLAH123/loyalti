 ...
 * @codeCoverageIgnore
 */
class CreateConversionRequestMobileForm extends AbstractForm
{
    ...
    protected function initialize(): void
    {
            ...
            $this->addBasic()
                ->addFields(
                    Builder::typography('description')
                        ->plainText(__p('activitypoint::phrase.your_account_cannot_send_conversion_requests_at_this_time'))
                );
        ...
        $canCreateForm = policy_check(ConversionRequestPolicy::class, 'createForm', $context);
        $this->addHeader(['showRightHeader' => $canCreateForm])
