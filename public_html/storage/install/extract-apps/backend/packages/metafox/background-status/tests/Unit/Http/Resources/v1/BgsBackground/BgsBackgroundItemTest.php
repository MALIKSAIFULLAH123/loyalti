...
use MetaFox\BackgroundStatus\Http\Resources\v1\BgsBackground\BgsBackgroundItem as Resource;
use MetaFox\BackgroundStatus\Http\Resources\v1\BgsBackground\BgsBackgroundItemCollection as ResourceCollection;
use MetaFox\BackgroundStatus\Models\BgsBackground as Model;
use MetaFox\BackgroundStatus\Models\BgsCollection;
use Tests\TestCase;

class BgsBackgroundItemTest extends TestCase
{
    /**
     * @return Model $model
     */
