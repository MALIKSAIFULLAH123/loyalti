...
use MetaFox\BackgroundStatus\Http\Resources\v1\StatusBackground\StatusBackgroundItem as Resource;
use MetaFox\BackgroundStatus\Http\Resources\v1\StatusBackground\StatusBackgroundItemCollection as ResourceCollection;
use MetaFox\BackgroundStatus\Models\StatusBackground as Model;
use Tests\TestCase;

class StatusBackgroundItemTest extends TestCase
{
    /**
     * @return Model $model
     */
