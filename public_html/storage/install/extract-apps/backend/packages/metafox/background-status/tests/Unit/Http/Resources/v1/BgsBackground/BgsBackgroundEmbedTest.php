...
use MetaFox\BackgroundStatus\Http\Resources\v1\BgsBackground\BgsBackgroundEmbed as Resource;
use MetaFox\BackgroundStatus\Http\Resources\v1\BgsBackground\BgsBackgroundEmbedCollection as ResourceCollection;
use MetaFox\BackgroundStatus\Models\BgsBackground as Model;
use MetaFox\BackgroundStatus\Models\BgsCollection;
use Tests\TestCase;

class BgsBackgroundEmbedTest extends TestCase
{
    /**
     * @return Model $model
     */
