...
return [
    ...
    [
        'driver'     => 'MetaFox\\BackgroundStatus\\Http\\Resources\\v1\\BgsBackground\\Admin\\WebSetting',
        'type'       => 'resource-web',
        'name'       => 'pstatusbg_background',
        'version'    => 'v1',
        'resolution' => 'admin',
        'is_active'  => true,
        'is_preload' => false,
        'alias'      => 'pstatusbg_background',
    ],
    [
        'driver'     => 'MetaFox\\BackgroundStatus\\Http\\Resources\\v1\\BgsBackground\\Admin\\EditBackgroundForm',
        'type'       => 'form',
        'name'       => 'bgs.pstatusbg_background.edit',
        'version'    => 'v1',
        'resolution' => 'admin',
        'is_active'  => true,
        'is_preload' => false,
