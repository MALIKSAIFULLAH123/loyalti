...
class DataGrid extends Grid
{
    ...
    protected function initialize(): void
    {
        ...
        $this->withActions(function (Actions $actions) {
            ...
            $this->getPublishActionMenu($actions);
        ...
        $this->withItemMenu(function (ItemActionMenu $menu) {
            ...
            $this->getPublishActionMenu($menu);
        ...
        $this->withExtraData([
            'show_total'        => true,
            'total_item_phrase' => 'total_value_blogs',
        ]);
    }
    ...
    protected function getSponsoredActionMenu(ItemActionMenu|Actions $actionMenu): void
    {
        ...
        if ($actionMenu instanceof ItemActionMenu) {
            $actionMenu->addItem('sponsor')
                ->action('sponsor')
                ->value(MetaFoxForm::ACTION_ADMINCP_BATCH_ITEM)
                ->label(__p('blog::phrase.sponsor_this_item'))
                ->reload()
                ->showWhen([
                    'and',
            ...
            $actionMenu->addItem('unsponsor')
                ->action('unsponsor')
                ->value(MetaFoxForm::ACTION_ADMINCP_BATCH_ITEM)
                ->label(__p('blog::phrase.unsponsor_this_item'))
                ->reload()
                ->showWhen([
                    'and',
    ...
    protected function getSponsoredInFeedActionMenu(ItemActionMenu|Actions $actionMenu): void
    {
        ...
        if ($actionMenu instanceof ItemActionMenu) {
            $actionMenu->addItem('sponsorInFeed')
                ...
                ->value(MetaFoxForm::ACTION_ADMINCP_BATCH_ITEM)
                ->label(__p('blog::phrase.sponsor_in_feed'))
                ->reload()
                ->showWhen([
                    'and',
            ...
            $actionMenu->addItem('unsponsorInFeed')
                ...
                ->value(MetaFoxForm::ACTION_ADMINCP_BATCH_ITEM)
                ->label(__p('blog::phrase.un_sponsor_in_feed'))
                ->reload()
                ->showWhen([
                    'and',
    ...
    protected function getPublishActionMenu(ItemActionMenu|Actions $actionMenu): void
    {
        if ($actionMenu instanceof Actions) {
            $actionMenu->add('publish')
                ->asPatch()
                ->apiUrl("{$this->appName}/publish/:id");
        }

        if ($actionMenu instanceof ItemActionMenu) {
            $actionMenu->addItem('publish')
                ->action('publish')
                ->value(MetaFoxForm::ACTION_ADMINCP_BATCH_ITEM)
