...
namespace MetaFox\Page\Support\Browse\Scopes\PageSimilar;
...
class WhenScope extends PlatformWhenScope
{
    ...
    public function apply(Builder $builder, Model $model)
    {
        ...
        $builder->leftJoin('page_members', function (JoinClause $join) {
            $join->on('page_members.page_id', '=', 'pages.id');
            $this->applyJoinBuilder($join);
        })->whereNotNull('page_members.page_id');
    }
