...
class MobileSetting extends ResourceSetting
{
    protected function initialize(): void
    {
        ...
        $this->add('addItem')
            ->apiUrl('core/mobile/form/advertise.store')
            ->pageUrl('advertise/add');

        $this->add('editItem')
            ->apiUrl('core/mobile/form/advertise.edit/:id')
        ...
        $this->add('paymentItem')
            ->apiUrl('core/mobile/form/advertise.payment/:id');

        $this->add('searchForm')
            ->apiUrl('core/mobile/form/advertise.search_form');
        ...
        $this->add('getChartForm')
            ->apiUrl('core/mobile/form/advertise.search_chart_form/:id')
            ->asGet();
        ...
        $this->add('searchItem')
            ...
            ->apiParams([
                ...
                'status'       => ':status',
                'placement_id' => ':placement_id',
            ])->placeholder(__p('advertise::phrase.search_advertise'));
    }
}
