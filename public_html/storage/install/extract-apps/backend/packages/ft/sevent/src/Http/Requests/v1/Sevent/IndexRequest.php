...
class IndexRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sevent_id'           => ['sometimes', 'nullable', 'numeric'],
            'ticket_id'           => ['sometimes', 'nullable', 'numeric'],
            'qty'           => ['sometimes', 'nullable', 'numeric'],
            'sview'           => ['sometimes', 'nullable'],
            'distance'           => ['sometimes', 'nullable'],
            'ex'           => ['sometimes', 'nullable', 'integer', 'min:1'],
            'country_iso'           => ['sometimes', 'nullable'],
            ...
            'type_id' => ['sometimes', 'nullable', 'numeric'],
            'sortPopular'        => SortScope::rules(),
            'sort_type'   => SortScope::sortTypes(),
            'when'        => WhenScope::rules(),
            'whenPopular' => WhenScope::rules(),
            'category_id' => ['sometimes', 'nullable', 'integer', 'exists:sevent_categories,id'],
            ...
            'is_featured' => ['sometimes', new AllowInRule([0, 1])],
    ...
    {
        return [
            'category_id.exists' => __p('sevent::validation.category_is_unavailable'),
        ];
    }
