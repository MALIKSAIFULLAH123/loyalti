...
{
    protected string $type = 'sevent_payment_pending_notification';
    ...
    {
        return $this->localize('sevent::phrase.payment_pending_message');
    }
    ...
    public function toMail(): ?MailMessage
    {
        ...
        $subject = $this->localize('sevent::phrase.payment_pending_email_subject');

        $message = $this->localize('sevent::phrase.payment_pending_email_message');
